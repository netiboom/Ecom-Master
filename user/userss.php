...
<body>
  ...
  <header class="fixed w-full h-auto z-10" style="transform: translateY(-100px);">
    <nav id="topHead" class="top-head w-full h-[38px] bg-[#0D92F4]" style="font-family: 'Itim', cursive;">
    ...
    <nav class="bg-white border-b border-gray-200  w-full z-10">
      <div class="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          ...
          <div class="menu-sec hidden md:flex space-x-[40px] items-center" style="font-family: 'Itim', cursive; font-weight: bold;">
            <a href="user.php" class="text-gray-700 hover:text-[#FFF] hover:bg-[#0D92F4] h-full w-[100px] flex items-center justify-center">Home</a>
            <a href="../product_list.php" class="text-gray-700 hover:text-[#FFF] hover:bg-[#0D92F4] h-full w-[100px] flex items-center justify-center">Products</a>

            <a href="../contact.php" class="text-gray-700 hover:text-[#FFF] hover:bg-[#0D92F4] h-full w-[100px] flex items-center justify-center">Contact us</a>
          </div>

          <!-- Cart Icon Section -->
          <div class="flex items-center space-x-4" style="font-family: 'Itim', cursive;">
            <div class="relative group">
              <button id="services-btn" class="text-gray-700 hover:text-[#0D92F4] focus:outline-none">
                account
              ...
              <div id="dropdown-menu" class="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md py-2 z-20 hidden group-hover:block">
                <a href="../user_order.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#0D92F4] hover:text-[#FFF] "><i class="fa-regular fa-bag-shopping"></i> My orders</a>
                <a href="../profile.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#0D92F4] hover:text-[#FFF] "><i class="fa-regular fa-user"></i> Profile</a>
                <a href="../logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#0D92F4] hover:text-[#FFF] "><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
              </div>
            </div>
            <a href="../shoping_cart.php" class="relative w-[70px] h-full flex items-center justify-center bg-[#0D92F4] text-white hover:text-[#000]">
            ...
            <!-- Toggle Button -->
            <button class="md:hidden focus:outline-none text-gray-700 hover:text-[#0D92F4]" id="navbar-toggle">
      ...
      <div class="md:hidden hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3" style="font-family: 'IBM Plex Sans Thai', sans-serif; font-weight: bold;">
          <a href="user.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-[#0D92F4]">Home</a>
          <a href="../product_list.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-[#0D92F4]">Product</a>
          <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-[#0D92F4]">About</a>
          <a href="../contact.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-[#0D92F4]">Contact us</a>
          <a href="../logout.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-[#0D92F4]">Logout</a>
        </div>
      </div>
    </nav>
  </header>
  ...
  <section class="bg-white py-12 w-full h-[500px] mt-[100px]">
    <div class="banner-con max-w-[1140px] mx-auto px-6 lg:flex lg:items-center lg:justify-between">
      ...
      <div class="lg:w-1/2 lg:pr-12" data-aos="fade-up" data-aos-duration="500">
        ...
        HI <span style="color: #0D92F4;">Pomeranian</span>
        </h2>
        ...
        <a href="../product_list.php" style="font-family: 'IBM Plex Sans Thai', sans-serif; font-weight: bold;" class="mt-6 inline-block bg-[#0D92F4] text-white px-7 py-3 shadow-[#0D92F4] hover:bg-purple-700 transition ease-in-out duration-300">
          เลือกซื้อสินค้า
        </a>
      </div>
  ...
  <div class="w-full h-auto bg-[#FFF] mt-[150px]">
    <section class="max-w-[1140px] h-auto category_list mx-auto" style="font-family: 'Itim', system-ui;">
      ...
      <div class="headtextcate px-5 w-full h-[30px] flex items-center justify-between">
        ...
        <h1 class="text-black text-[30px] font-extrabold"><span class="text-[#0D92F4]">Hot </span>sale <i class="fa-solid fa-grid-2-plus text-sm text-[#0D92F4]"></i></h1>


        <div class="h-auto w-[50px] flex items-center justify-between">
          <div class="leftclick cursor-pointer w-[25px] text-white bg-[#0D92F4] flex items-center justify-center px-[10px] py-[5px]"><i class="fa-solid fa-chevron-left"></i></div>
          <div class="rightclick cursor-pointer w-[25px] text-white bg-[#0D92F4] flex items-center justify-center ml-[10px] px-[10px] py-[5px]"><i class="fa-solid fa-chevron-right"></i></div>
        </div>
          ...
          <?php while ($row = $result2->fetch(PDO::FETCH_ASSOC)): ?>
            ...
            <div class="swiper-slide item__product relative m-4 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md" data-aos="fade-up" data-aos-duration="1000">
              ...
              <div class="mt-4 px-5 pb-5">
                <a href="#">
                  <h5 class="text-md tracking-tight text-slate-900 font-semibold hover:text-[#0D92F4]" style="font-family: 'IBM Plex Sans Thai', sans-serif;">
                ...
                <form action="cart.php" method="post" class="add-to-cart-form">
                  ...
                  <button type="submit" class=" w-full" style="border:none; border-radius:50%; background:none;">
                    <a style="font-family: 'Itim', cursive;" class="flex items-center justify-center rounded-md bg-[#0D92F4] hover:bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300">
              ...
              <div class="bannerhotsale bg-[#0D92F4] w-6 h-9 flex items-center justify-center" style="clip-path: polygon(0% 0%, 100% 0, 100% 100%, 50% 78%, 0 100%); position: absolute ; right: 0;">
  ...
  <section class="auction-today w-full my-[100px]">
    <div class="head-auc max-w-[1140px] h-[50px] mx-auto mb-[70px] px-6" style="font-family: 'IBM Plex Sans Thai', sans-serif;" data-aos="fade-up" data-aos-duration="1000">
      <h1 class="text-[30px]" style="font-family: 'Itim', cursive; font-weight:bold ;"><span class="text-[#0D92F4]">Pomeranian</span> Products</h1>
