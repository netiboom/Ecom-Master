...
<body>
  ...
  <header class=" w-full h-auto z-10 fixed" style="transform: translateY(-300px);">
    ...
    <ul class="breadcrumb">
      <div class="conbred mx-auto max-w-[1080px]" style="font-family: 'IBM Plex Sans Thai', sans-serif;">
        ...
        <li class="font-semibold text-neutral-800"><a href="#">Products</a></li>
  ...
  <section class="auction-today w-full my-[300px]" style="font-family: 'Itim', cursive;">
    <div class="head-auc max-w-[1140px] h-[50px] mx-auto mb-[100px] px-6" style="font-family: 'IBM Plex Sans Thai', sans-serif;" data-aos="fade-up" data-aos-duration="1000">
      <h1 class="text-[30px] sm:text-[40px] font-bold" style="font-family: 'Itim', cursive;"><span class="text-[#FF5733]">Pomeranian</span> Products</h1>
      <p class="max-w-[550px] text-gray-600">Explore a variety of dog breeds to suit your needs. Find the best deals and browse through categories.</p>
    </div>

    <div class="filter-section max-w-[1140px] px-6 mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6">
      <!-- Sidebar Filter -->
      <div class="filter-sidebar p-6 bg-white shadow-lg rounded-lg">

        <!-- Search Box -->
        <div class="search-box">
          <form action="" method="GET" class="relative">
            <input type="text" name="search" placeholder="Search products..." class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= htmlspecialchars($_GET['search'] ?? '') ?>">
            <button type="submit" class="absolute left-[160px] top-0 text-white bg-[#FF5733] px-4 py-[9px] hover:bg-blue-600" style="border-top-right-radius: 5px; border-bottom-right-radius:5px;"><i class="fa-solid fa-magnifying-glass"></i></button>
          </form>
        </div>

        <!-- Category List -->
        <div class="category-list mb-6 mt-3">
          <h3 class="mb-3"></h3>
          <ul class="list-disc list-inside">
            <?php foreach ($resultcategory as $row) : ?>
              <li class="mb-2" style="list-style-type: none;"><a href="?category=<?= $row["category_name"]; ?>" class="text-black font-bold hover:underline w-full h-[40px] flex items-center justify-center hover:bg-[#FF5733] hover:text-white " style="text-decoration: none; transition: .2s;"><?= $row["category_name"]; ?></a></li>
            <?php endforeach ?>
          </ul>
        </div>
      ...
      <!-- Product Listings -->
      <div class="auc-con lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 justify-items-center">
        <?php
        ...
        ?>
              <div class="item__product relative m-4 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="mt-4 px-5 pb-5">
                  ...
                  <form action="./user/cart.php" method="post" class="add-to-cart-form">
